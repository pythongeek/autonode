<?php
/**
 * Plugin Name: AutoNode Pro
 * Plugin URI: https://codecanyon.net/user/bdowneertech
...
define( 'AUTONODE_DB_VERSION', 6 );

/**
 * Explicit file loading — deterministic order, no autoloader, no stubs.
...
function autonode_load_files(): void {
    $files = [
        ...
        'includes/licensing/License_Admin.php',
        /* REST layer */
        ...
        'includes/REST/Discovery_Controller.php',  /* NEW: n8n Dynamic Discovery */
...
register_activation_hook(   AUTONODE_FILE, function( $network_wide ) { \AutoNode\Installer::activate( $network_wide ); } );
register_deactivation_hook( AUTONODE_FILE, function( $network_wide ) { \AutoNode\Installer::deactivate( $network_wide ); } );
