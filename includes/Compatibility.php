...
final class Compatibility {
    ...
    public static function app_password_notice(): void {
        ...
        printf(
            ...
            wp_kses_post( __( '<strong>AutoNode WP:</strong> Your theme enables WordPress Application Passwords globally. %s', 'autonode-pro') ),
            '<a href="' . esc_url( admin_url( 'admin.php?page=autonode-compat' ) ) . '">' . esc_html__( 'View security recommendation →', 'autonode-pro') . '</a>'
        );
        echo '</p></div>';
    }
