...
<div class="amp-wrap">
    <div class="amp-header">
        <div class="amp-header-left">
            <h1 class="amp-page-title"><?php esc_html_e( 'n8n Starter Workflows', 'autonode-pro'); ?></h1>
            <p><?php esc_html_e( 'One-click copyable n8n workflows specifically designed for AutoNode WP.', 'autonode-pro'); ?></p>
        </div>
    </div>
    ...
    <div class="amp-grid-2">
        ...
        <div class="amp-card amp-template-card amp-template-master">
            <div class="amp-card-header">
                <h3>🚀 <?php esc_html_e( 'Master AI Agent Starter', 'autonode-pro'); ?></h3>
                <button class="amp-btn amp-btn-primary button button-primary amp-copy-btn" data-target="tpl-master"><?php esc_html_e( 'Copy Master Workflow', 'autonode-pro'); ?></button>
            </div>
            <div class="amp-card-body">
                <p><?php esc_html_e( 'The ultimate production-ready workflow. Includes a centralized Config Hub, WP connection health checks, and a One-Shot Publish demonstration with SEO and Media.', 'autonode-pro'); ?></p>
                <div class="amp-workflow-preview">
                    <span class="node config"><?php esc_html_e( 'Config Hub', 'autonode-pro'); ?></span> <span class="node webhook"><?php esc_html_e( 'Manual Trigger', 'autonode-pro'); ?></span> <span class="node http"><?php esc_html_e( 'Status Check', 'autonode-pro'); ?></span> <span class="node http"><?php esc_html_e( 'One-Shot Publish', 'autonode-pro'); ?></span>
                </div>
            </div>
        ...
        <div class="amp-card amp-template-card">
            <div class="amp-card-header">
                <h3><?php esc_html_e( 'Post with Rank Math SEO', 'autonode-pro'); ?></h3>
                <button class="amp-btn amp-btn-primary button button-primary amp-copy-btn" data-target="tpl-oneshot"><?php esc_html_e( 'Copy Workflow', 'autonode-pro'); ?></button>
            </div>
            <div class="amp-card-body">
                <p><?php esc_html_e( 'Creates a live post, sideloads a featured image, and sets all Rank Math metadata in a single HTTP node.', 'autonode-pro'); ?></p>
                <div class="amp-workflow-preview">
                    <span class="node webhook"><?php esc_html_e( 'Webhook', 'autonode-pro'); ?></span>  <span class="node http"><?php esc_html_e( 'HTTP Request (AutoNode WP)', 'autonode-pro'); ?></span>
                </div>
            </div>
        ...
        <div class="amp-card amp-template-card">
            <div class="amp-card-header">
                <h3><?php esc_html_e( 'Receive WP Webhooks', 'autonode-pro'); ?></h3>
                <button class="amp-btn amp-btn-primary button button-primary amp-copy-btn" data-target="tpl-receiver"><?php esc_html_e( 'Copy Workflow', 'autonode-pro'); ?></button>
            </div>
            <div class="amp-card-body">
                <p><?php esc_html_e( 'Catches our optimized flattened JSON payloads when a post is published, ready for processing.', 'autonode-pro'); ?></p>
                <div class="amp-workflow-preview">
                    <span class="node webhook"><?php esc_html_e( 'Webhook', 'autonode-pro'); ?></span>  <span class="node set"><?php esc_html_e( 'Filter Payload', 'autonode-pro'); ?></span>
                </div>
            </div>
